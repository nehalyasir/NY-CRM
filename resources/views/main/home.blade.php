...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <title>Home - Powered By NY-Tech</title>
      ...
      <div class="content">
        ...
        <div class="row g-0 justify-content-between align-items-center h-100">
          <div class="col-12 col-sm-auto text-center">
            <p class="mb-0 mt-2 mt-sm-0 text-900">Thank you for creating with NY-Tech<span class="d-none d-sm-inline-block">
              </span><span class="d-none d-sm-inline-block mx-1">|</span>
              <br class="d-sm-none" />2023 &copy;<a class="mx-1" href="https://themewagon.com">NY-Tech</a></p>
          </div>
          <div class="col-12 col-sm-auto text-center">
