...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <title>Add Customers - Powered By NY-Tech</title>
  ...
  <body>
    ...
    <main class="main" id="top">
        ...
        <div class="content">
            ...
            <form class="mb-9" action="{{url('/')}}/admin/customers/addcustomers" method="post">
                @csrf
                {{-- @php
                    echo "<pre>";
                        print_r($errors->all());
                ...
                <div class="row g-3 flex-between-end mb-5">
                    <div class="col-auto">
                        <h2 class="mb-2">Add a Customer</h2>
                    ...
                    <div class="col-auto">
                        ...
                        <button class="btn btn-primary mb-2 mb-sm-0" type="submit">Publish Customer</button>
                    </div>
                </div>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-12 col-xl-8">
                        <div class="mb-3 col-xs-3 col-sm-3 col-m-3 col-l-3 col-xl-3 ">
                            ...
                            <input class="form-control mb-5 " type="text" name="code" placeholder="Code"  disabled/>
                        </div>

                        <div class="mb-6">
                            <h4 class="mb-3">Customer Name</h4>
                            <input class="form-control " type="text" name="name" placeholder="Write Customer Name here..." value="{{old('name')}}"/>
                            <input class="form-control mb-5" type="text" name="urname" placeholder="Write Customer Urdu Name here..." value="{{old('urname')}}"/>
                        ...
                        <div class="dropzone dropzone-multiple p-0 mb-5" id="my-awesome-dropzone" data-dropzone="data-dropzone">
                            <div class="fallback">
                                <input name="file" name="customerimg" type="file" multiple="multiple" />
                            </div>
                            <div class="dz-preview d-flex flex-wrap">
                                <div class="border bg-white rounded-3 d-flex flex-center position-relative me-2 mb-2" style="height:80px;width:80px;">
                                    <img class="dz-image" name="customerimgs" src="{{asset('/assets/img/products/23.png')}}" alt="..." data-dz-thumbnail="data-dz-thumbnail" />
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row gx-3">
                                            ...
                                            <div class="col-12 col-sm-6 col-xl-12">
                                                <div class="mb-3">
                                                    <h5 class="text-1000">Active</h5>
                                                    <div class="form-check">
                                                        <input class="form-check-input" id="flexCheckDefault" type="checkbox" name="checkactive" value="" checked="" />
                                                        <label class="form-check-label" for="flexCheckDefault">Customer Active</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-sm-6 col-xl-12">
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control mb-2" type="email" name="email" placeholder="Write Customer Email" value="{{old('email')}}"/>
                                                </div>
                                                <span class="text-danger">
                                                    @error('email')
                                                        {{$message}}
                                            ...
                                            <div class="col-12 col-sm-6 col-xl-12">
                                                <div class="mb-3">
                                                    <h5 class="text-1000">Phone Number</h5>
                                                    <input class="form-control mb-2" type="number" name="phonenumber" placeholder="Write Phone Number" value="{{old('phonenumber')}}"/>
                                                    <span class="text-danger">
                                                        @error('phonenumber')
                                                            {{$message}}
                                                        @enderror
                                            ...
                                            <div class="col-12 col-sm-6 col-xl-12">
                                                <div class="mb-3">
                                                    <h5 class="text-1000">Cnic</h5>
                                                    <input class="form-control mb-2" type="number" name="cnic" placeholder="Write Cnic Number" value="{{old('cnic')}}"/>
                                                    <span class="text-danger">
                                                        @error('phonenumber')
                                                            {{$message}}
                                                        @enderror
                                            ...
                                            <div class="col-12 col-sm-6 col-xl-12">
                                                <div class="mb-3">
                                                    <div class="d-flex flex-wrap">
                                                        <h5 class="text-1000 me-2">Gender</h5>
                                                    </div>
                                                    <select class="form-select mb-2" aria-label="gender" name="gender">
                                            ...
                                            <div class="col-12 col-sm-6 col-xl-12">
                                                <div class="mb-3">
                                                    <div class="d-flex flex-wrap">
                                                        <h5 class="text-1000 me-2">Customer Type</h5>
                                                    </div>
                                                    <select class="form-select mb-2" aria-label="category" name="customertype">
                                                        <option value="Coil Contractor">Coil Contractor</option>
                                                        <option value="Coil Contractor">Coil Contractor</option>
                                                        <option value="Coil Contractor">Coil Contractor</option>
                                                        <option value="Coil Contractor">Coil Contractor</option>
                                                        <option value="Coil Contractor">Coil Contractor</option>
                                            ...
                                            <div class="col-12 col-sm-6 col-xl-12">
                                                <div class="mb-3">
                                                    ...
                                                    <textarea class="form-control" name="address" data-tinymce='{"height":"15rem","placeholder":"Write a address here..."}'></textarea>
                                                    <span class="text-danger">
                                                        @error('address')
                                                            {{$message}}
                                                        @enderror
                                            ...
                                            <div class="col-12 col-sm-6 col-xl-12">
                                                <div class="mb-3">
                                                    <h5 class="text-1000">Country</h5>
                                                    <input class="form-control mb-2" type="text" name="country" placeholder="Write Customer Country" value="{{old('country')}}"/>
                                                    <span class="text-danger">
                                                        @error('country')
                                                            {{$message}}
                                                        @enderror
                                            ...
                                            <div class="col-12 col-sm-6 col-xl-12">
                                                <div class="mb-3">
                                                    <h5 class="text-1000">City</h5>
                                                    <input class="form-control mb-2" type="text" name="city" placeholder="Write Customer City" value="{{old('city')}}"/>
                                                    <span class="text-danger">
                                                        @error('city')
                                                            {{$message}}
                                                        @enderror
                                            ...
                                            <div class="col-12 col-sm-6 col-xl-12">
                                                <div class="mb-3">
                                                    <h5 class="text-1000">City Code</h5>
                                                    <input class="form-control mb-2" type="number" name="citycode" placeholder="Write City Code" value="{{old('citycode')}}"/>
                                                    <span class="text-danger">
                                                        @error('citycode')
                                                            {{$message}}
                                                        @enderror
