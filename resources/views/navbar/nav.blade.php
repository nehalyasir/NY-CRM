<nav class="navbar navbar-vertical navbar-expand-lg" style="display:none;">
    ...
    <script src="{{url('assets/js/navbarStyle.js')}}"></script>
    ...
    <div class="collapse navbar-collapse" id="navbarVerticalCollapse">
        ...
        <div class="navbar-vertical-content">
            ...
            <li class="nav-item">
                ...
                <div class="parent-wrapper label-1">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="{{url('/')}}" data-bs-toggle="" aria-expanded="false">
                ...
                <div class="parent-wrapper label-1">
                    ...
                    <li class="nav-item"><a class="nav-link dropdown-indicator" href="#nv-admin" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-admin">
                        ...
                        <ul class="nav collapse parent show" data-bs-parent="#e-commerce" id="nv-admin">
                            <li class="nav-item"><a class="nav-link" href="{{ route('AddProducts')}}" data-bs-toggle="" aria-expanded="false">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Add product</span></div>
                            </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('ViewProducts')}}" data-bs-toggle="" aria-expanded="false">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Products</span></div>
                            </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('AddCustomers')}}" data-bs-toggle="" aria-expanded="false">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Add Customers</span></div>
                            </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('ViewCustomers')}}" data-bs-toggle="" aria-expanded="false">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Customers</span></div>
                            </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('SalesOrders')}}" data-bs-toggle="" aria-expanded="false">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Sales Orders</span></div>
                            </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('SalesInvoice')}}" data-bs-toggle="" aria-expanded="false">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Sales Invoice</span></div>
                            </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('PurchaseOrders')}}" data-bs-toggle="" aria-expanded="false">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Purchase Orders</span></div>
                            </a><!-- more inner pages-->
                            </li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('PurchaseInvoice')}}" data-bs-toggle="" aria-expanded="false">
                                <div class="d-flex align-items-center"><span class="nav-link-text">Purchase Invoice</span></div>
                            </a><!-- more inner pages-->
                            </li>
        ...
        <li class="nav-item">
            ...
            <div class="nav-item-wrapper">
                <a class="nav-link label-1" href="{{ route('clearCache')}}" role="button" data-bs-toggle="" aria-expanded="false">
                    <div class="d-flex align-items-center">
                        <span class="nav-link-icon">
                            <span data-feather="refresh-cw"></span>
                        </span>
                        <span class="nav-link-text-wrapper">
                            <span class="nav-link-text">Clear Cache</span>
                        </span>
                    </div>
                </a>
            </div><!-- parent pages-->
  ...
  <nav class="navbar navbar-top fixed-top navbar-expand" id="navbarDefault" style="display:none;">
    ...
    <div class="navbar-logo">
        ...
        <div class="d-flex align-items-center">
            <div class="d-flex align-items-center"><img src="{{url('/assets/img/icons/nytech.png')}}" alt="phoenix" width="27" />
            <p class="logo-text ms-2 d-none d-sm-block">NY-Tech</p>
            </div>
        </div>
        </a>
    </div>
  ...
  <nav class="navbar navbar-top navbar-slim fixed-top navbar-expand" id="topNavSlim" style="display:none;">
    ...
    <div class="navbar-logo">
        <button class="btn navbar-toggler navbar-toggler-humburger-icon hover-bg-transparent" type="button" data-bs-toggle="collapse" data-bs-target="#navbarVerticalCollapse" aria-controls="navbarVerticalCollapse" aria-expanded="false" aria-label="Toggle Navigation"><span class="navbar-toggle-icon"><span class="toggle-line"></span></span></button>
        <a class="navbar-brand navbar-brand" href="{{url('/')}}">NY-Tech <span class="text-1000 d-none d-sm-inline">slim</span></a>
    </div>
    <ul class="navbar-nav navbar-nav-icons flex-row">
        <li class="nav-item">
  ...
  <nav class="navbar navbar-top fixed-top navbar-expand-lg" id="navbarTop" style="display:none;">
    ...
    <ul class="navbar-nav navbar-nav-top" data-dropdown-on-hover="data-dropdown-on-hover">
        ...
        <ul class="dropdown-menu navbar-dropdown-caret">
            <li><a class="dropdown-item active" href="{{url('/')}}">
        ...
        <ul class="dropdown-menu navbar-dropdown-caret">
            ...
            <ul class="dropdown-menu">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{url('/admin/products/addproduct')}}">
                        <div class="dropdown-item-wrapper"><span class="me-2 uil"></span>Add product</div>
                    </a></li>
                    <li><a class="dropdown-item" href="{{url('/admin/products/viewproduct')}}">
  ...
  <script src="{{url('assets/js/navbarTopShape.js')}}"></script>
